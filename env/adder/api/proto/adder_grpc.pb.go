...
const (
	...
	Adder_AddMany_FullMethodName = "/adder.Adder/AddMany"
)
...
type AdderClient interface {
	Add(ctx context.Context, in *AddCommand, opts ...grpc.CallOption) (*AddCommandResponse, error)
	AddMany(ctx context.Context, in *AddManyCommand, opts ...grpc.CallOption) (*AddCommandResponse, error)
}
...
func (c *adderClient) Add(ctx context.Context, in *AddCommand, opts ...grpc.CallOption) (*AddCommandResponse, error) {
...
func (c *adderClient) AddMany(ctx context.Context, in *AddManyCommand, opts ...grpc.CallOption) (*AddCommandResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AddCommandResponse)
	err := c.cc.Invoke(ctx, Adder_AddMany_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AdderServer interface {
	Add(context.Context, *AddCommand) (*AddCommandResponse, error)
	AddMany(context.Context, *AddManyCommand) (*AddCommandResponse, error)
...
func (UnimplementedAdderServer) Add(context.Context, *AddCommand) (*AddCommandResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Add not implemented")
}
func (UnimplementedAdderServer) AddMany(context.Context, *AddManyCommand) (*AddCommandResponse, error) {
...
func _Adder_Add_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdderServer).Add(ctx, req.(*AddCommand))
	}
	return interceptor(ctx, in, info, handler)
}

func _Adder_AddMany_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddManyCommand)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AdderServer).AddMany(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Adder_AddMany_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdderServer).AddMany(ctx, req.(*AddManyCommand))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Adder_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AddMany",
			Handler:    _Adder_AddMany_Handler,
		},
	},
