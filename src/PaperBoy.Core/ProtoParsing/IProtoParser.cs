...
public interface IProtoParser
{
    ...
    /// <summary>
    /// This method use Google.Protobuf.JsonFormatter to return JSON-structured data from CLR Type generated by protoc util.
    /// </summary>
    ...
    /// <returns>Human-readable JSON for all messages from proto file with data stubs.</returns>
    public Task<string> ParseToJsonWithStubDynamic(
        Stream originalProtoFile,
        string fileName,
        CancellationToken cancellationToken);
